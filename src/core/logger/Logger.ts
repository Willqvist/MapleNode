export default abstract class Logger {
  ...
  static log(tag: string, msg: string) {
    if (Logger.logger && (Logger.listensTo.has(tag) || Logger.listensTo.has('all'))) Logger.logger.log(msg);
  }
  ...
  static error(tag: string, msg: string) {
    if (Logger.logger && (Logger.listensTo.has(tag) || Logger.listensTo.has('all'))) Logger.logger.error(msg);
  }
  ...
  static warn(tag: string, msg: string) {
    if (Logger.logger && (Logger.listensTo.has(tag) || Logger.listensTo.has('all'))) Logger.logger.warn(msg);
  }
  ...
  static info(tag: string, msg: string) {
    if (Logger.logger && (Logger.listensTo.has(tag) || Logger.listensTo.has('all'))) Logger.logger.info(msg);
  }
   ...
   */
  static clear() {
    if (Logger.logger) Logger.logger.clear();
  }
