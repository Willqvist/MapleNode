class CryptoConstants
{
    constructor()
    {
        ...
        this.bDefaultAESKeyValue = [
            0xC6, 0x50, 0x53, 0xF2, 0xA8, 0x42, 0x9D, 0x7F, 0x77, 0x09, 0x1D, 0x26, 0x42, 0x53, 0x88, 0x7C,
        ];

        this.WZ_GMSIV = [0x4D, 0x23, 0xC7, 0x2B];

		this.WZ_MSEAIV = [0xB9, 0x7D, 0x63, 0xE9];

        this.WZ_OffsetConstant = 0x581C3F6D;
        this.versions = 
        {
            GMS:0,
            EMS:1,
    ...
    getTrimmedUserKey()
    {
        ...
        {
            key[i / 4] = this.userKey[i];
        }
        return key;
    }
}
const c = new CryptoConstants();
module.exports = c;