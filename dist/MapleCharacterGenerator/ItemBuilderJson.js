...
class ItemBuilder extends ImageBuilder_1.default {
    constructor() {
        super();
        this.canvas = new Canvas_1.default(96, 96);
        this.offsetX = 44;
        this.offsetY = 33;
        this.parts = {};
    ...
    setCoat(id, z, next) {
        if (!fs_1.default.existsSync(this.getPath("Coat", id) + "coord.xml"))
            return next();
        this.setUpperBodyCloth(id, z, next, "Coat");
    }
    setLongCoat(id, z, next) {
        if (!fs_1.default.existsSync(this.getPath("LongCoat", id) + "coord.xml"))
            return next();
    ...
    setWeaponInfo(id) {
        let file = this.parser.parseFromString(fs_1.default.readFileSync(__dirname + "/gd//Weapon/0" + id + ".img/coord.xml", "utf8"), "text/xml");
...
//# sourceMappingURL=ItemBuilderJson.js.map